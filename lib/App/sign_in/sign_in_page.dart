...
import 'package:time_tracker_flutter_course/App/social-sign-in-button.dart';
...
void _showSignInError(BuildContext context, Exception exception){
  if(exception is FirebaseException && exception.code == 'ERROR_ABORTED_BU_USER'){
    return;
  }
  ...
  void _signInWithEmail(BuildContext context){
    ...
    Navigator.of(context).push(           //navigator widget works using navigation stack-push and pop
