...
@override
  ...
  void _toggleFormType(){
    setState(() {
      ...
      EmailSignInFormType.registers : EmailSignInFormType.signIn;
    });
  ...
  labelText: 'Password',
    ...
    obscureText: true,         // to make the password not visible (in dots)
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Column(
        mainAxisSize: MainAxisSize.min, //size to fit the page
        crossAxisAlignment: CrossAxisAlignment.stretch,     // sign in size like of the page
